...
namespace WangxiaoCN
{
    ...
    /// </summary>
    public partial class WXAdminLogsOpration: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<WXAdminLogsOpration> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<WXAdminLogsOpration>(new WangxiaoCN.WangxiaoCNDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<WXAdminLogsOpration> testlist){
            SetTestRepo();
            foreach (var item in testlist)
            {
                _testRepo._items.Add(item);
        ...
        public static void Setup(WXAdminLogsOpration item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            SetTestRepo();
            for(int i=0;i<testItems;i++){
                WXAdminLogsOpration item=new WXAdminLogsOpration();
                _testRepo._items.Add(item);
            }
        }
        ...
        IRepository<WXAdminLogsOpration> _repo;
        ITable tbl;
        bool _isNew;
        public bool IsNew(){
            return _isNew;
        ...
        WangxiaoCN.WangxiaoCNDB _db;
        public WXAdminLogsOpration(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            _dirtyColumns=new List<IColumn>();
            if(TestMode){
                WXAdminLogsOpration.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<WXAdminLogsOpration>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public WXAdminLogsOpration(Expression<Func<WXAdminLogsOpration, bool>> expression):this() {
        ...
        internal static IRepository<WXAdminLogsOpration> GetRepo(string connectionString, string providerName){
            WangxiaoCN.WangxiaoCNDB db;
            if(String.IsNullOrEmpty(connectionString)){
                db=new WangxiaoCN.WangxiaoCNDB();
            }else{
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<WXAdminLogsOpration>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<WXAdminLogsOpration> GetRepo(){
            return GetRepo("","");
        }
        
        public static WXAdminLogsOpration SingleOrDefault(Expression<Func<WXAdminLogsOpration, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            WXAdminLogsOpration single=null;
            if(results.Count() > 0){
                single=results.ToList()[0];
                single.OnLoaded();
                single.SetIsLoaded(true);
        ...
        public static WXAdminLogsOpration SingleOrDefault(Expression<Func<WXAdminLogsOpration, bool>> expression,string connectionString, string providerName) {
            var repo = GetRepo(connectionString,providerName);
            var results=repo.Find(expression);
            WXAdminLogsOpration single=null;
            if(results.Count() > 0){
        ...
        public static bool Exists(Expression<Func<WXAdminLogsOpration, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<WXAdminLogsOpration, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<WXAdminLogsOpration> Find(Expression<Func<WXAdminLogsOpration, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<WXAdminLogsOpration> Find(Expression<Func<WXAdminLogsOpration, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<WXAdminLogsOpration> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<WXAdminLogsOpration> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<WXAdminLogsOpration> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<WXAdminLogsOpration> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<WXAdminLogsOpration> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<WXAdminLogsOpration> GetPaged(int pageIndex, int pageSize) {
            return GetRepo().GetPaged(pageIndex, pageSize);
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(WXAdminLogsOpration)){
                WXAdminLogsOpration compare=(WXAdminLogsOpration)obj;
                return compare.KeyValue()==this.KeyValue();
            }else{
                return base.Equals(obj);
            }
        ...
        public static void Delete(Expression<Func<WXAdminLogsOpration, bool>> expression) {
            var repo = GetRepo();
    ...
    /// </summary>
    public partial class WXAdminPowerTree: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<WXAdminPowerTree> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<WXAdminPowerTree>(new WangxiaoCN.WangxiaoCNDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<WXAdminPowerTree> testlist){
            SetTestRepo();
            foreach (var item in testlist)
            {
                _testRepo._items.Add(item);
        ...
        public static void Setup(WXAdminPowerTree item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            SetTestRepo();
            for(int i=0;i<testItems;i++){
                WXAdminPowerTree item=new WXAdminPowerTree();
                _testRepo._items.Add(item);
            }
        }
        ...
        IRepository<WXAdminPowerTree> _repo;
        ITable tbl;
        bool _isNew;
        public bool IsNew(){
            return _isNew;
        ...
        WangxiaoCN.WangxiaoCNDB _db;
        public WXAdminPowerTree(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            _dirtyColumns=new List<IColumn>();
            if(TestMode){
                WXAdminPowerTree.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<WXAdminPowerTree>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public WXAdminPowerTree(Expression<Func<WXAdminPowerTree, bool>> expression):this() {
        ...
        internal static IRepository<WXAdminPowerTree> GetRepo(string connectionString, string providerName){
            WangxiaoCN.WangxiaoCNDB db;
            if(String.IsNullOrEmpty(connectionString)){
                db=new WangxiaoCN.WangxiaoCNDB();
            }else{
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<WXAdminPowerTree>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<WXAdminPowerTree> GetRepo(){
            return GetRepo("","");
        }
        
        public static WXAdminPowerTree SingleOrDefault(Expression<Func<WXAdminPowerTree, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            WXAdminPowerTree single=null;
            if(results.Count() > 0){
                single=results.ToList()[0];
                single.OnLoaded();
                single.SetIsLoaded(true);
        ...
        public static WXAdminPowerTree SingleOrDefault(Expression<Func<WXAdminPowerTree, bool>> expression,string connectionString, string providerName) {
            var repo = GetRepo(connectionString,providerName);
            var results=repo.Find(expression);
            WXAdminPowerTree single=null;
            if(results.Count() > 0){
        ...
        public static bool Exists(Expression<Func<WXAdminPowerTree, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<WXAdminPowerTree, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<WXAdminPowerTree> Find(Expression<Func<WXAdminPowerTree, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<WXAdminPowerTree> Find(Expression<Func<WXAdminPowerTree, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<WXAdminPowerTree> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<WXAdminPowerTree> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<WXAdminPowerTree> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<WXAdminPowerTree> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<WXAdminPowerTree> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<WXAdminPowerTree> GetPaged(int pageIndex, int pageSize) {
            return GetRepo().GetPaged(pageIndex, pageSize);
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(WXAdminPowerTree)){
                WXAdminPowerTree compare=(WXAdminPowerTree)obj;
                return compare.KeyValue()==this.KeyValue();
            }else{
                return base.Equals(obj);
            }
        ...
        public static void Delete(Expression<Func<WXAdminPowerTree, bool>> expression) {
            var repo = GetRepo();
    ...
    /// <summary>
    /// A class which represents the WXDataCollections table in the WangxiaoCN Database.
    /// </summary>
    public partial class WXDataCollection: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<WXDataCollection> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<WXDataCollection>(new WangxiaoCN.WangxiaoCNDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<WXDataCollection> testlist){
            SetTestRepo();
            foreach (var item in testlist)
            {
                _testRepo._items.Add(item);
        ...
        public static void Setup(WXDataCollection item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            SetTestRepo();
            for(int i=0;i<testItems;i++){
                WXDataCollection item=new WXDataCollection();
                _testRepo._items.Add(item);
            }
        }
        ...
        IRepository<WXDataCollection> _repo;
        ITable tbl;
        bool _isNew;
        public bool IsNew(){
            return _isNew;
        ...
        WangxiaoCN.WangxiaoCNDB _db;
        public WXDataCollection(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            _dirtyColumns=new List<IColumn>();
            if(TestMode){
                WXDataCollection.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<WXDataCollection>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public WXDataCollection(Expression<Func<WXDataCollection, bool>> expression):this() {
        ...
        internal static IRepository<WXDataCollection> GetRepo(string connectionString, string providerName){
            WangxiaoCN.WangxiaoCNDB db;
            if(String.IsNullOrEmpty(connectionString)){
                db=new WangxiaoCN.WangxiaoCNDB();
            }else{
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<WXDataCollection>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<WXDataCollection> GetRepo(){
            return GetRepo("","");
        }
        
        public static WXDataCollection SingleOrDefault(Expression<Func<WXDataCollection, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            WXDataCollection single=null;
            if(results.Count() > 0){
                single=results.ToList()[0];
                single.OnLoaded();
                single.SetIsLoaded(true);
        ...
        public static WXDataCollection SingleOrDefault(Expression<Func<WXDataCollection, bool>> expression,string connectionString, string providerName) {
            var repo = GetRepo(connectionString,providerName);
            var results=repo.Find(expression);
            WXDataCollection single=null;
            if(results.Count() > 0){
        ...
        public static bool Exists(Expression<Func<WXDataCollection, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<WXDataCollection, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<WXDataCollection> Find(Expression<Func<WXDataCollection, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<WXDataCollection> Find(Expression<Func<WXDataCollection, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<WXDataCollection> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<WXDataCollection> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<WXDataCollection> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<WXDataCollection> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<WXDataCollection> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<WXDataCollection> GetPaged(int pageIndex, int pageSize) {
            return GetRepo().GetPaged(pageIndex, pageSize);
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(WXDataCollection)){
                WXDataCollection compare=(WXDataCollection)obj;
                return compare.KeyValue()==this.KeyValue();
            }else{
                return base.Equals(obj);
            }
        ...
        public int? ksid
        {
            ...
            set
            {
                if(_ksid!=value){
                    _ksid=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="ksid");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public int? typeid
        {
            ...
            set
            {
                if(_typeid!=value){
                    _typeid=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="typeid");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public static void Delete(Expression<Func<WXDataCollection, bool>> expression) {
            var repo = GetRepo();
    ...
    public partial class WXExamDetail: IActiveRecord
    {
        ...
        Guid? _RulesGID;
        public Guid? RulesGID
        {
            get { return _RulesGID; }
            set
            {
                if(_RulesGID!=value){
                    _RulesGID=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="RulesGID");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public string Analysis
        {
            ...
            set
            {
                if(_Analysis!=value){
                    _Analysis=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="Analysis");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public string ReviewCount
        {
            ...
            set
            {
                if(_ReviewCount!=value){
                    _ReviewCount=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="ReviewCount");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        string _AnalyseNum;
        public string AnalyseNum
        {
            get { return _AnalyseNum; }
            set
            {
                if(_AnalyseNum!=value){
                    _AnalyseNum=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="AnalyseNum");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
    ...
    public partial class WXExamPaper: IActiveRecord
    {
        ...
        public int? tExamID
        {
            ...
            set
            {
                if(_tExamID!=value){
                    _tExamID=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="tExamID");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public int? tKSID
        {
            ...
            set
            {
                if(_tKSID!=value){
                    _tKSID=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="tKSID");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
    ...
    /// <summary>
    /// A class which represents the WXExamRules table in the WangxiaoCN Database.
    /// </summary>
    public partial class WXExamRule: IActiveRecord
    {
    
        #region Built-in testing
        static TestRepository<WXExamRule> _testRepo;
        

        
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<WXExamRule>(new WangxiaoCN.WangxiaoCNDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        }
        public static void Setup(List<WXExamRule> testlist){
            SetTestRepo();
            foreach (var item in testlist)
            {
                _testRepo._items.Add(item);
        ...
        public static void Setup(WXExamRule item) {
            SetTestRepo();
            _testRepo._items.Add(item);
        }
        public static void Setup(int testItems) {
            SetTestRepo();
            for(int i=0;i<testItems;i++){
                WXExamRule item=new WXExamRule();
                _testRepo._items.Add(item);
            }
        }
        ...
        WangxiaoCN.WangxiaoCNDB _db;
        public WXExamRule(string connectionString, string providerName) {
        ...
        void Init(){
            ...
            _dirtyColumns=new List<IColumn>();
            if(TestMode){
                WXExamRule.SetTestRepo();
                _repo=_testRepo;
            }else{
                _repo = new SubSonicRepository<WXExamRule>(_db);
            }
            tbl=_repo.GetTable();
            SetIsNew(true);
            OnCreated();       
        ...
        public WXExamRule(Expression<Func<WXExamRule, bool>> expression):this() {
        ...
        internal static IRepository<WXExamRule> GetRepo(string connectionString, string providerName){
            WangxiaoCN.WangxiaoCNDB db;
            if(String.IsNullOrEmpty(connectionString)){
                db=new WangxiaoCN.WangxiaoCNDB();
            }else{
            ...
            if(db.TestMode){
                ...
                _repo = new SubSonicRepository<WXExamRule>(db);
            }
            return _repo;        
        }       
        
        internal static IRepository<WXExamRule> GetRepo(){
            return GetRepo("","");
        }
        
        public static WXExamRule SingleOrDefault(Expression<Func<WXExamRule, bool>> expression) {

            var repo = GetRepo();
            var results=repo.Find(expression);
            WXExamRule single=null;
            if(results.Count() > 0){
                single=results.ToList()[0];
                single.OnLoaded();
                single.SetIsLoaded(true);
        ...
        public static WXExamRule SingleOrDefault(Expression<Func<WXExamRule, bool>> expression,string connectionString, string providerName) {
            var repo = GetRepo(connectionString,providerName);
            var results=repo.Find(expression);
            WXExamRule single=null;
            if(results.Count() > 0){
        ...
        public static bool Exists(Expression<Func<WXExamRule, bool>> expression,string connectionString, string providerName) {
           
            return All(connectionString,providerName).Any(expression);
        }        
        public static bool Exists(Expression<Func<WXExamRule, bool>> expression) {
           
            return All().Any(expression);
        }        

        public static IList<WXExamRule> Find(Expression<Func<WXExamRule, bool>> expression) {
            
            var repo = GetRepo();
            return repo.Find(expression).ToList();
        }
        
        public static IList<WXExamRule> Find(Expression<Func<WXExamRule, bool>> expression,string connectionString, string providerName) {

            var repo = GetRepo(connectionString,providerName);
            return repo.Find(expression).ToList();

        }
        public static IQueryable<WXExamRule> All(string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetAll();
        }
        public static IQueryable<WXExamRule> All() {
            return GetRepo().GetAll();
        }
        
        public static PagedList<WXExamRule> GetPaged(string sortBy, int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(sortBy, pageIndex, pageSize);
        }
      
        public static PagedList<WXExamRule> GetPaged(string sortBy, int pageIndex, int pageSize) {
            return GetRepo().GetPaged(sortBy, pageIndex, pageSize);
        }

        public static PagedList<WXExamRule> GetPaged(int pageIndex, int pageSize,string connectionString, string providerName) {
            return GetRepo(connectionString,providerName).GetPaged(pageIndex, pageSize);
            
        }


        public static PagedList<WXExamRule> GetPaged(int pageIndex, int pageSize) {
            return GetRepo().GetPaged(pageIndex, pageSize);
        ...
        public override bool Equals(object obj){
            if(obj.GetType()==typeof(WXExamRule)){
                WXExamRule compare=(WXExamRule)obj;
                return compare.KeyValue()==this.KeyValue();
            }else{
                return base.Equals(obj);
            }
        ...
        public int? SSorts
        {
            ...
            set
            {
                if(_SSorts!=value){
                    _SSorts=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="S_Sorts");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        {
            get { return _RulesTitle; }
            set
            {
                if(_RulesTitle!=value){
                    _RulesTitle=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="RulesTitle");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        decimal? _RulesScore;
        public decimal? RulesScore
        {
            get { return _RulesScore; }
            set
            {
                if(_RulesScore!=value){
                    _RulesScore=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="RulesScore");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        string _RulesScoreSet;
        public string RulesScoreSet
        {
            get { return _RulesScoreSet; }
            set
            {
                if(_RulesScoreSet!=value){
                    _RulesScoreSet=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="RulesScoreSet");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
        ...
        public static void Delete(Expression<Func<WXExamRule, bool>> expression) {
            var repo = GetRepo();
    ...
    public partial class WXSysExamCategory: IActiveRecord
    {
        ...
        public int? isBottom
        {
            ...
            set
            {
                if(_isBottom!=value){
                    _isBottom=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="isBottom");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
